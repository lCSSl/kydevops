package work.kaiyu.common.datascope.aspect;
...
import work.kaiyu.common.datascope.service.AwaitUserService;
...
public class DataScopeAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(work.kaiyu.common.datascope.annotation.DataScope)")
