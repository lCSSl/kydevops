package work.kaiyu.common.security.service;
...
import work.kaiyu.common.core.enums.UserStatus;
import work.kaiyu.common.core.exception.BaseException;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    private UserDetails getUserDetails(R<UserInfo> result) {
        ...
        LoginUser loginUser = new LoginUser(user.getUserId(), user.getUserName(), user.getPassword(),
                true, true, true, true,
                authorities);
